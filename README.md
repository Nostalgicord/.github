# Nostalgicord
## About
Nostalgicord is a Discord archival project archiving web builds, web experiments and videos from Discord's YT page. Also having a (planned) Fosscord/Litecord instance, documents workings of Discord (client and discord_desktop_core module), and a modded (and legal) Discord client to load web builds.
